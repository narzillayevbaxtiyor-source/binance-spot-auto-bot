...
async def post_init(app: Application):
    ...
    # ✅ PTBUserWarning chiqmasligi uchun Application.create_task emas,
    # oddiy asyncio.create_task ishlatamiz (ma'no o'zgarmaydi).
    asyncio.create_task(entry_scanner(app))
    asyncio.create_task(monitor_positions(app))
    asyncio.create_task(snapshot_state_task())

    await tg_send(app, f"✅ START | TF={INTERVAL} | BUY=approval | SELL=auto")
